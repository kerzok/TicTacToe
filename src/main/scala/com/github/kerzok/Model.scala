...
object Model {
  ...
  final case class GameFinished(gameId: String)
  final case class CreateGameRequest(side: GameSide)
  final case class CreateGameResponse(status: String,
                                      gameId: Option[String] = None,
                                      url: Option[String] = None,
                                      errorMessage: Option[String] = None)
  final case class JoinGameRequest(gameId: String)
  final case class JoinGameResponse(status: String,
                                    url: Option[String] = None,
                                    side: Option[GameSide] = None,
                                    errorMessage: Option[String] = None)
